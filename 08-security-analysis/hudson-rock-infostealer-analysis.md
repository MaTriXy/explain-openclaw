...
| 5 | `soul.md` contains agent principles | **CONFIRMED** | User-defined workspace `.md` file loaded into system prompt (`src/agents/workspace.ts:481-541`). Note: located in workspace dir, NOT in `~/.openclaw/` |
